...
class LeaderboardAdmin(admin.ModelAdmin):
    list_display = ['_id', 'user_id', 'team_id', 'total_calories', 'total_activities', 'rank', 'updated_at']
...
class WorkoutAdmin(admin.ModelAdmin):
    list_display = ['_id', 'name', 'category', 'difficulty', 'duration', 'calories_per_session']
